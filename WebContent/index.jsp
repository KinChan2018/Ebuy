				...
				<div class="news-list">
					...
					<ul>
						<c:forEach var="notice" items="${noticeList }">
							<li><a href="notice_showNotice.action?noticeId=${notice.id }" target="_blank">${notice.title }</a></li>
						</c:forEach>
					</ul>
				</div>
				...
				<div class="news-list">
					...
					<ul>
						<c:forEach var="news" items="${newsList }">
							<li><a href="news_showNews.action?newsId=${news.id }" target="_blank">${news.title }</a></li>
						</c:forEach>
					</ul>
				</div>
			</div>
